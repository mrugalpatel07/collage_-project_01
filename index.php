        ...
        <div class="col-md-7 col-lg-10 pl-2 pl-xl-5">
          <form class="form-inline flex-nowrap form-domainSearch" method="post">
            <div class="form-group">
              ...
              <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder=" Enrollnment Number / Mobile Number"> 
            </div>
...
$sdata=$_POST['searchdata'];
 ...
 <?php
$sql="SELECT * from tblpass where  enrollmentnumber like '$sdata%'";
...
<td colspan="6" style="font-size:20px;color:blue">
 Enrollnment No: <?php  echo ($row->enrollmentnumber);?></td></tr>
  ...
  <tr>
    ...
    <th scope>Enrollnment Number</th>

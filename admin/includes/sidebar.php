...
{               ?>
    ...
    <li>
                        <a href="#"><i class="fa fa-users fa-fw"></i>Facaulty<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-subadmin.php">Add Facaulty</a>
                            </li>
                            <li>
                                <a href="manage-subadmins.php">Manage Facaulty</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>

...
$eid=$_GET['editid'];
$sql="update tblpass set FullName=:fname,ContactNumber=:cnum,Email=:email,IdentityType=:itype,IdentityCardno=:icnum,Category=:cat,FromDate=:fdate,ToDate=:tdate,enrollmentnumber=:enrollmentnumber where ID=:eid";
...
<head>
    ...
    <title>Gate Pass Management System | Edit Pass</title>
...
{               ?> 
 ...
 Pass ID: <?php  echo ($row->PassNumber);?></p>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Enrollment Number</label> <input type="text" name="enrollmentnumber" value="<?php  echo $row->enrollmentnumber;?>" class="form-control" required='true'> </div>
...
<option value="Sem 6">Sem 6</option>
   ...
   <!-- <div class="form-group"> <label for="exampleInputEmail1">Identity Card No.</label> <input type="text" name="icnum" value="<?php  echo $row->IdentityCardno;?>" class="form-control" required='true'> </div>-->
     <div class="form-group"> <label for="exampleInputEmail1">Category</label><select type="text" name="category" value="" class="form-control">
...
<div class="form-group"> <label for="exampleInputEmail1">From Date</label> <input type="datetime-local" name="fromdate" value="<?php  echo $row->FromDate;?>" class="form-control" required='true'> </div>
<div class="form-group"> <label for="exampleInputEmail1">To Date</label> <input type="datetime-local" name="todate" value="<?php  echo $row->ToDate;?>" class="form-control" required='true'> </div>

...
<head>
    ...
    <title>Gate Pass Management System | Add Role</title>
...
<body>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Role Name</label> <input type="text" name="catname" value="" class="form-control" required='true'> </div>

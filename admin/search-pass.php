...
<form method="post">
                                <div class="form-group">
                                    <label>Search by Pass Number/Mobile Number/Enrollnment Number</label>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
$sql="SELECT * from tblpass where PassNumber like '$sdata%'|| ContactNumber like '$sdata%'|| enrollmentnumber like '$sdata%'";
